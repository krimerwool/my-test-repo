      ...
      {sources.length > 0 && (
        <div className="mt-4 mb-3">
          <details className="group">
            <summary className="text-xs font-semibold text-gray-500 dark:text-neutral-400 mb-2 cursor-pointer list-none flex items-center hover:text-gray-700 dark:hover:text-neutral-300 transition-colors">
              Data Sources Used <span className="ml-1 text-[10px] opacity-70 group-open:rotate-180 transition-transform">▼</span>
            </summary>
            <div className="p-3 bg-white dark:bg-neutral-800 rounded-lg border border-gray-100 dark:border-neutral-700">
